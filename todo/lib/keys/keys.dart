          ...
          child: Column(
            children: [
              ...
              for (final todo in _orderedTodos)
                CheckableTodoItem(
                  key: ValueKey(todo.text), // los valores de ValueKey deben ser únicos y estar directamente conectados con el contenido del widget.
                  //key: ObjectKey(todo), Esto es otra alternativa. 
                  todo.text,
                  todo.priority,
                ),
            ],
